...
echo "---- $(date +'%H:%M:%S')|${sample_name}:00:Getting IDs of Reads having less than 1bp out of low map Region ------"
repeat_reads=${INTERMEDIATE}/${sample_name}.ReadIDs_in_LowMapRegions.out

## get read ids of reads in not having atleast 1bp out of lowMapRegions
